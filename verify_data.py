...
def user_input(row, index, allow_n: bool = True):
    ...
    try:
        for index, row in dataframe.iterrows():
            while True:
                ...
                if correct != "n":
                    dataframe, previous = fix_current(
                        dataframe, correct, index, row)
                    break
